...
namespace Core6App.Repository.Migrations
{
    ...
    [Migration("20220902221203_test2")]
    partial class test2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core6App.Core.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core6App.Core.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core6App.Core.Models.ProductFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core6App.Core.Models.Product", b =>
                {
                    b.HasOne("Core6App.Core.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Core6App.Core.Models.ProductFeature", b =>
                {
                    b.HasOne("Core6App.Core.Models.Product", "Product")
                        .WithOne("ProductFeature")
                        .HasForeignKey("Core6App.Core.Models.ProductFeature", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
